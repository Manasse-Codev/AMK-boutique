        ...
        {isOpen && (
          <div className="fixed inset-0 z-50 overflow-hidden">
            ...
            <div className="fixed inset-y-0 right-0 max-w-full flex pl-4 sm:pl-10">
              <motion.div
                key="cart-panel"
                initial={{ x: '100%', opacity: 0.95, scale: 0.99 }}
                animate={{ x: 0, opacity: 1, scale: 1 }}
                exit={{ x: '100%', opacity: 0.95, scale: 0.99 }}
                transition={{ type: 'spring', damping: 28, stiffness: 280, mass: 0.9 }}
                className="w-screen max-w-md bg-brand-cream/90 backdrop-blur-xl border-l border-white/60 shadow-2xl h-full flex flex-col justify-between p-6 md:p-8 relative z-10"
              >
                ...
                <div>
                  ...
                  {/* Cart Items List with Smooth Enter/Exit Motion */}
                  <div className="divide-y divide-brand-border/60 max-h-[50vh] overflow-y-auto pr-1 mt-4">
                    {items.length === 0 ? (
                ...
                <div className="border-t border-brand-border/70 pt-5 space-y-3.5">
